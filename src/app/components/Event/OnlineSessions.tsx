...
export default function OnlineSessions() {
  return (
    <section className="mx-2 md:mx-4 lg:mx-8 py-4 md:py-10 mt-10">
      ...
      {/* Title */}
      <h2 className="font-roboto text-[20px] md:text-[38px] lg:text-[56px] font-bold text-[#1A1A1A] px-4 md:px-0 mt-2 md:mt-0">
        Zinkq Online Sessions
      </h2>

    <div className="w-full px-4 md:px-0" >
      <div className="w-full h-[2px] bg-gray-400 mb-4 md:mb-10  " />
    </div>
